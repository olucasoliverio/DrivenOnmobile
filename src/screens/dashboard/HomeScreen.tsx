...
const styles = StyleSheet.create({
  ...
  barTrack: { width: 14, height: 80, borderRadius: borderRadius.full, backgroundColor: '#F1F5F9', justifyContent: 'flex-end', overflow: 'hidden' },
  barFill: { width: '100%', borderRadius: borderRadius.full },
  barLabel: { fontSize: 10, color: palette.slate400, marginTop: 2 },
  barValue: { fontSize: 9, color: palette.slate400, marginBottom: 2 },
  ...
  osColorBar: { width: 4, borderTopLeftRadius: 12, borderBottomLeftRadius: 12 },
  ...
  osNumBox: { backgroundColor: '#F1F5F9', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  osNumText: { fontSize: 12, fontWeight: '700', color: palette.slate700 },
  ...
  osDivider: { height: 1, backgroundColor: '#F1F5F9', marginVertical: spacing.sm },
